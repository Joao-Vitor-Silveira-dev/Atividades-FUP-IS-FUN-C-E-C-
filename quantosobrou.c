#include <stdio.h>
    int main(){
        ...
        float preco1,preco2,preco3,dinheiro,gasto;
            scanf("%d %d %d %f %f %f %f",&produto1,&produto2,&produto3,&preco1,&preco2,&preco3,&dinheiro);
                gasto=((produto1*preco1)+(produto2*preco2)+(produto3*preco3));
                    printf("%.2f\n",dinheiro-gasto);
